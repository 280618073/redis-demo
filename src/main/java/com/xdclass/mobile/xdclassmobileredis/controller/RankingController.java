...
import com.xdclass.mobile.xdclassmobileredis.service.RankingService;
...
public class RankingController {
    ...
    @ResponseBody
    @RequestMapping("/sale/upUserScore")
    public String upUserScore(String uid,Integer score) {
        rankingService.upSaleScore(uid,score);
        return "success";
    }
    ...
    public List<Map<String,Object>> saleScoreByRange(Integer start, Integer end) { //几分到几分
